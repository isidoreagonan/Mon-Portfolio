...
export const PROJECTS: Project[] = [
  {
    ...
    role: 'Co-créateur & Développeur (En équipe)',
    category: 'saas',
    description: 'Une plateforme d\'e-learning moderne conçue et développée en équipe pour révolutionner l\'apprentissage des compétences digitales avec des systèmes de monétisation intégrés.',
    longDescription: 'Technova Learning est un système complet de gestion de l\'apprentissage (LMS) orienté vers le futur, co-créé avec mon équipe. Il intègre des tunnels de conversion intelligents, des processus d\'onboarding automatisés et des récompenses par gamification pour maximiser le taux de rétention des élèves.',
    tags: ['React', 'SaaS', 'E-Learning', 'Stripe API', 'Automation', 'Travail en Équipe'],
    metrics: '+45% engagement étudiant',
    linkUrl: 'https://technovalearning.com',
    linkText: 'technovalearning.com',
  ...
  },
  {
    ...
    role: 'Stratège & Réalisateur Vidéo',
    category: 'ugc',
  ...
  },
  {
    ...
    title: 'Chaîne YouTube - AGONAN ISIDORE',
    role: 'Youtubeur & Créateur de contenu (@AgonanIsidore)',
    category: 'automation',
    description: 'Chaîne YouTube dédiée au décryptage de l\'IA appliquée au travail en ligne. Tutoriels pratiques, automatisation, analyse d\'outils et stratégies concrètes pour passer à l\'action (2 vidéos / semaine).',
    longDescription: 'Créateur et animateur de la chaîne YouTube AGONAN ISIDORE (@AgonanIsidore) comptabilisant plus de 1,66 k abonnés et 95+ vidéos publiées à un rythme régulier de 2 vidéos par semaine. La chaîne a pour mission de décrypter le digital et l\'intelligence artificielle pour les mettre concrètement au service de vos projets de business en ligne et d\'automatisation.',
    tags: ['YouTube', 'IA Appliquée', 'Travail en Ligne', 'Création de Contenu', '2 Vidéos/Semaine', 'Automatisation'],
    metrics: '+1,66 k Abonnés • 95+ Vidéos',
    linkUrl: 'https://www.youtube.com/@AgonanIsidore',
    linkText: 'youtube.com/@AgonanIsidore',
    mediaType: 'image',
    placeholderColor: 'rgba(236, 72, 153, 0.15)',
    features: [
      'Publication régulière de 2 vidéos par semaine à forte valeur ajoutée',
      'Décryptage et vulgarisation de l\'IA appliquée au travail en ligne',
      'Workflows d\'automatisation concrète (CapCut Pro, scripts IA, tunnels de conversion)',
      'Communauté active et engagée de plus de 1 660 abonnés sur YouTube'
    ],
    softwareUsed: ['CapCut Pro', 'Adobe After Effects', 'YouTube Studio', 'Outils IA Générative', 'SEO Vidéo']
  }
];
