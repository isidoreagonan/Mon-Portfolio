...
export default function HeroSection() {
  ...
  const stats = [
    ...
    { value: '2 SaaS', label: 'Plateformes', desc: 'Technova & Ducatilio', icon: Cpu, color: 'text-brand-cyan' },
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
        ...
        <div className="max-w-4xl">
          <h1
            id="hero-title"
            className="text-5xl sm:text-7xl lg:text-8xl font-black leading-[0.95] tracking-tighter uppercase italic mb-6"
          >
            <span className="block text-white">AGONAN ISIDORE ABRAHAM</span>
            <span className="block mt-2 text-brand-emerald">
          ...
          <p
            id="hero-subtitle"
            className="text-lg sm:text-xl text-neutral-400 font-sans font-light leading-snug mb-10 max-w-2xl"
          >
          ...
          {/* Buttons */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-4 sm:space-y-0 sm:space-x-5 mb-16">
            <button
